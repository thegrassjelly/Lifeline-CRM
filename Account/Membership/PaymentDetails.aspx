<%@ Page Title="" Language="C#" MasterPageFile="~/Account/customer.master" AutoEventWireup="true" CodeFile="PaymentDetails.aspx.cs" Inherits="Account_Membership_PaymentDetails" %>
                    ...
                    <div class="x_content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-7 col-xs-12">
                                <asp:TextBox ID="txtEmail" runat="server" class="form-control" ReadOnly="True" />
                            </div>
                        </div>
                        <hr />
                    </div>
                                ...
                                <asp:ListView ID="lvGetDependents" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td><%# Eval("LastName") %></td>
                                            <td>
                                                <a href='PaymentDetailsUpDep.aspx?ID=<%# Eval("DependentID") %>' class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Update</a>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                    <EmptyDataTemplate>
            ...
            <div class="col-lg-6">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-4 col-xs-12">Total Amount</label>
                            <div class="col-lg-4 col-xs-12 text-right">
