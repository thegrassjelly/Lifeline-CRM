<%@ Page Title="" Language="C#" MasterPageFile="~/Account/customer.master" AutoEventWireup="true" CodeFile="Payments.aspx.cs" Inherits="Account_Membership_Payments" %>
    ...
    <form class="form-horizontal" runat="server">
            ...
            <div class="form-group pull-left">
                ...
                <div class="col-lg-12">
                    ...
                    <table class="table table-striped projects">
                        ...
                        <tbody>
                            <asp:ListView ID="lvPendingPayments" runat="server" OnPagePropertiesChanging="lv_PagePropertiesChanging">
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <a href='PaymentDetails.aspx?ID=<%# Eval("MembershipID") %>' class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> Details </a>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                                <EmptyDataTemplate>
        ...
        <div class="x_panel">
            <div class="text-center">
                <asp:DataPager ID="lvDataPager" runat="server" PagedControlID="lvPendingPayments" PageSize="5">
                    <Fields>
