<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true" CodeFile="IssueInquiryReport.aspx.cs" Inherits="Admin_Feedback_Reports_IssueInquiryReport" %>
        ...
        <div class="x_panel">
            ...
            <asp:UpdatePanel runat="server">
                <ContentTemplate>
                    ...
                    <div class="x_content">
                        <CR:CrystalReportViewer ID="crvIssueInquiry" runat="server" AutoDataBind="True"
