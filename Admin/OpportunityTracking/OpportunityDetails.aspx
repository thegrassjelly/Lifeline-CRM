<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true" CodeFile="OpportunityDetails.aspx.cs" Inherits="Admin_OpportunityTracking_OpportunityDetails" %>
    ...
    <form class="form-horizontal" runat="server">
        <div class="col-lg-6 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div id="opportunity" runat="server" class="alert alert-success text-center" visible="false">
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-4 col-lg-8">
                            <asp:Button ID="btnUpdate" runat="server" class="btn btn-primary pull-right" Text="Update"
                                OnClick="btnUpdate_OnClick" OnClientClick="return confirm('Are you sure?')" />
                        </div>
                    </div>
                </div>
            </div>
