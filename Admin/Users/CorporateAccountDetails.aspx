        ...
        <div class="col-lg-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div class="form-group">
                        <div class="col-lg-offset-4 col-lg-8">
                            <asp:Button ID="btnPrint2" runat="server" class="btn btn-primary pull-right" Text="Employees Report"
                                OnClick="btnPrint2_Click" />
                            <asp:Button ID="btnPrint" runat="server" class="btn btn-primary pull-right" Text="Account Report"
