            ...
            $(".autosuggest").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        ...
                        url: "AddCorporateAccounts.aspx/SearchCity",
                ...
                <div class="x_content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7 col-sm-12 col-xs-12">
                            <asp:TextBox ID="txtCompanyName" runat="server" class="form-control" MaxLength="80" required/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-lg-4">Nature of Business</label>
                        <div class="col-lg-4 col-sm-12 col-xs-12">
                            <asp:DropDownList ID="ddlNature" runat="server" class="form-control" required>
