<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true" CodeFile="VoidedRenewals.aspx.cs" Inherits="Admin_Membership_VoidedRenewals" %>
    ...
    <form class="form-horizontal" runat="server">
        <div class="col-lg-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <a href='<%= Page.ResolveUrl("~/Admin/Membership/Reports/VoidRenewalsReport.aspx") %>' class="btn btn-primary btn-md pull-right">
