<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true" CodeFile="RenewalsReport.aspx.cs" Inherits="Admin_Membership_Reports_RenewalsReport" %>
        ...
        <div class="x_panel">
            ...
            <asp:UpdatePanel runat="server">
                <ContentTemplate>
                    ...
                    <div class="x_content">
                        <CR:CrystalReportViewer ID="crvRenewals" runat="server" AutoDataBind="True"
