<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true" CodeFile="ApplicationReport.aspx.cs" Inherits="Admin_Membership_Reports_ApplicationReport" %>
        ...
        <div class="x_panel">
            ...
            <asp:UpdatePanel runat="server">
                <ContentTemplate>
                    ...
                    <div class="x_content">
                        <CR:CrystalReportViewer ID="crvApplications" runat="server" AutoDataBind="True"
