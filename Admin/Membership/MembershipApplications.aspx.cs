...
public partial class Admin_Membership_MembershipApplications : System.Web.UI.Page
{
    ...
    DataSet GetApplications()
    {
        ...
        using (SqlCommand cmd = new SqlCommand())
        {
            ...
            cmd.CommandText = "SELECT ApplicationID, Applications.FirstName, Applications.LastName, Applications.Email, UserType, " +
                              "DateSubmitted FROM Applications INNER JOIN Users ON Applications.UserID=Users.UserID " +
                              "INNER JOIN Types ON Users.TypeID=Types.TypeID WHERE UserType != 'Client' ORDER BY ApplicationID DESC";
