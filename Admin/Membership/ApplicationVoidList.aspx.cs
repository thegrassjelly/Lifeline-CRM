...
public partial class Admin_Membership_ApplicationVoidList : System.Web.UI.Page
{
    ...
    DataSet GetApplications()
    {
        ...
        using (SqlCommand cmd = new SqlCommand())
        {
            ...
            cmd.CommandText = "SELECT ApplicationID, Applications.FirstName, Applications.LastName, Applications.Email, UserType, " +
                              ...
                              "= Payments.MembershipID WHERE Applications.Status = 'Voided' ORDER BY ApplicationID DESC";
