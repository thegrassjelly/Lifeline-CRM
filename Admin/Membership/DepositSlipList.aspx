<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true" CodeFile="DepositSlipList.aspx.cs" Inherits="Admin_Membership_DepositSlipList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
        ...
        <div class="x_panel">
            <div class="x_title">
                <h2>Deposit Slip Uploads List</h2>
