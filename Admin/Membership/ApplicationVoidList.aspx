<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true" CodeFile="ApplicationVoidList.aspx.cs" Inherits="Admin_Membership_ApplicationVoidList" %>
                ...
                <div class="col-lg-12">
                    ...
                    <dx:ASPxGridView ID="gvApplications" runat="server"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn FieldName="PaymentStatus" VisibleIndex="3">
                            </dx:GridViewDataTextColumn>
