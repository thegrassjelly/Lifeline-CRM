...
public partial class Admin_Membership_VoidedRenewals : System.Web.UI.Page
{
    ...
    DataSet GetMembershipList()
    {
        ...
        using (SqlCommand cmd = new SqlCommand())
        {
            ...
            cmd.CommandText = "SELECT Memberships.MembershipID, FirstName, LastName, StartDate, " +
                              ...
                              "ON Memberships.MembershipID=Payments.MembershipID WHERE MembershipStatus='Voided' " +
