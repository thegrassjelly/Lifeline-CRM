...
public partial class Admin_Membership_RenewalDetailsDepUpdate : System.Web.UI.Page
{
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        using (SqlCommand cmd = new SqlCommand())
        {
            ...
            Response.Redirect("~/Admin/Membership/RenewalDetails.aspx?ID=" + Session["MemID"].ToString()); 
        }
    }
}