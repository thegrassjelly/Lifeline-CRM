<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true" CodeFile="UpdateAmbulance.aspx.cs" Inherits="Admin_Operations_UpdateAmbulance" %>
    ...
    <form class="form-horizontal" runat="server">
        <div class="x_panel">
            ...
            <div class="col-lg-6">
                ...
                <div class="form-group">
                    <label class="control-label col-lg-4">Plate #</label>
                    <div class="col-lg-3 col-sm-12 col-xs-12">
                        <asp:TextBox ID="txtPlate" runat="server" class="form-control" MaxLength="7" required />
                    </div>
                </div>
                <div class="form-group">
